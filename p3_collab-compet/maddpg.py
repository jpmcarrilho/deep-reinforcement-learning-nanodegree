...
class MADDPG:
    def __init__(self, discount_factor=0.95, tau=0.02):
        ...
        # critic input = obs_full + actions = 24+2+2=20
        self.maddpg_agent = [DDPGAgent(24, 48, 32, 2, 52, 48, 16), 
                             DDPGAgent(24, 48, 32, 2, 52, 48, 16), 
                             ]
    ...
    def update(self, samples, agent_number, logger):
        ...
        target_critic_input = (next_obs,target_actions)
        with torch.no_grad():
